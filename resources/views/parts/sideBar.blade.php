<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item {{ Route::currentRouteName() == 'brand.index' || Route::currentRouteName() == 'gender.index' || Route::currentRouteName() == 'category.index' ? 'active' : '' }}">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
            <i class="fas fa-shopping-cart"></i> <span>Products</span>
        </a>
        <div id="collapseThree" class="collapse {{ Route::currentRouteName() == 'gender.index' || Route::currentRouteName() == 'brand.index' || Route::currentRouteName() == 'category.index'  ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                {{-- <h6 class="collapse-header">Custom Components:</h6> --}}
